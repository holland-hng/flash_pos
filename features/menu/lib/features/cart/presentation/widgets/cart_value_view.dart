...
class CartValueView extends StatelessWidget {
  final RxCombine<CartSummaryValue> rxOrderSummary;
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  "\$${rxOrderSummary.value?.subTotal.toStringAsFixed(2)}",
                  style: context.typo.subtitle1.medium,
                ),
              ],
            ),
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  "\$${rxOrderSummary.value?.tax.toStringAsFixed(2)}",
                  style: context.typo.subtitle1.medium,
                ),
              ],
            ),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("Total (${rxOrderSummary.value?.itemCount})",
                    style: context.typo.headline6.semiBold),
                Text(
                  "\$${rxOrderSummary.value?.total.toStringAsFixed(2)}",
                  style: context.typo.headline6.semiBold,
                ),
              ],
            ),
