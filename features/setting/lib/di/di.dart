...
@InjectableInit()
Future<void> settingFeatureConfigureDependencies({GetIt? mainGetIt}) async {
...
Future<void> registerRouter() async {
  final managerRouter = SettingRouter();
  final appRouter = AppRouter(managerRouter);
  getIt.registerSingleton<AppRouter>(appRouter);
}

void registerAppConfig() {
  getIt.registerSingleton<AppConfig>(SettingAppConfig(getIt<Dio>()));
}
